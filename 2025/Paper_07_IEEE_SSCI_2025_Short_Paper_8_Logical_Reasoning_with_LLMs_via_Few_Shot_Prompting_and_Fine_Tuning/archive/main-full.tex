...
Recent advancements in Large Language Models (LLMs) have revolutionized the field of natural language processing (NLP), enabling significant improvements in their ability to perform complex reasoning tasks \cite{chen2024large, hadi2024large}. Logical reasoning, in particular, remains a crucial yet challenging endeavor, as it requires not only an understanding of language but also the capacity to infer, deduce, and apply knowledge in contexts \cite{wang2024can, chu2024beyond}.
