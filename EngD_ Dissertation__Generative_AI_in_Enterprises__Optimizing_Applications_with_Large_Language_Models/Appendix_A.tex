...
The following examples illustrate the three outcome categories tracked by the multi-agent invoice reconciliation system (Chapter~\ref{ch:agentic}). These examples demonstrate the diagnostic value of the 12-category error taxonomy and ASR metric introduced in Section~\ref{sec:diagnostic_framework}.
...
1. Data Engineering Agent: Attempted batch query
   ...
   - Error Category: "Parameter Validation" (from 12-category taxonomy)
...
The 12-category error taxonomy introduced in Chapter~\ref{ch:agentic} classifies failures as follows:
