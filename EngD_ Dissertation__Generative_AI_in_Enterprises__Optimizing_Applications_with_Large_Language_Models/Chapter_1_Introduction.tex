...
\begin{enumerate}[leftmargin=*,resume]
    ...
    \item \textbf{Beyond Task Success: Measuring Workflow Fidelity in LLM-Based Agentic Payment Systems}~\cite{huang2026beyond}\\
    \textit{PAKDD 2026 Workshops} \textbf{(Accepted)}
