...
\begin{itemize}[leftmargin=*]
    ...
    \item Systematic error analysis through a structured diagnostic taxonomy for tool invocation failures
\end{itemize}
